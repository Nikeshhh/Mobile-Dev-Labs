Future<void> heatWater() {
  ...
  return Future.delayed(
      const Duration(seconds: 3), () => print('Конец нагрева воды'));
}

Future<void> heatCoffee() async {
  print('Начало заваривания кофе');
  return Future.delayed(
      const Duration(seconds: 5), () => print('Конец заваривания кофе'));
}
...
Future<void> mixMilk() {
  ...
  return Future.delayed(
      const Duration(seconds: 5), () => print('Конец взбивания молока'));
}
